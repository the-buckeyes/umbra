...
impl Identity {
    pub fn new(db: &MysqlConnection, registration: Registration) -> Result<Self, UmbraModelError> {
        use crate::models::{algorithm::Algorithm, organization::Organization, system::System};
        ...
        let organization = Organization::get_by_slug(db, &registration.organization)?;
